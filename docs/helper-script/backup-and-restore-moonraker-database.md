...
!!! Note
    You can also use `MOONRAKER_BACKUP_DATABASE` macro to backup Moonraker database when installing <a href="../useful-macros">Useful Macros</a> feature.
...
!!! Note
    You can also use `MOONRAKER_RESTORE_DATABASE` macro to restore Moonraker database when installing <a href="../useful-macros">Useful Macros</a> feature.
